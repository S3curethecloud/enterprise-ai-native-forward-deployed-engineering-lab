...
from incident_diagnostic_api.api.runtime import router as runtime_router
...
from incident_diagnostic_api.runtime import DeterministicRuntimeEngine
...
def create_app(settings: Settings | None = None) -> FastAPI:
    ...
    application = FastAPI(
        ...
        description=(
            "Local Phase 4 deterministic runtime foundation. External models, enterprise "
    ...
    if resolved_settings.service_name == "runtime":
        application.state.runtime_engine = DeterministicRuntimeEngine()
